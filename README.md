...
后续 API/事件目录、兼容矩阵和版本发布任务见 [剩余任务计划](docs/剩余任务计划.md)。
...
已发布目录不可原地修改。不兼容变更必须发布新主版本；兼容新增发布次版本；纯文档修正发布修订版本。详细流程见 [开发规范](docs/开发规范.md) 和 [契约说明](contracts/repository/README.md)。
